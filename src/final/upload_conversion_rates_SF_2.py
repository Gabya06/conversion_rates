"""
script to calculate and populate conversion rates into Conversion Rate object in SalesForce
"""
...
# set directory and project path in Windows machine
...
for i in t_dates:
    ...
    for rec in results:
        if rec['success'] == True:
            ...
            err_stat = rec['errors']['statusCode']
            print err_stat
