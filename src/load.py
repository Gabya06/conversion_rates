...
'''
# actual stages
stages = ['Prospect','Qualified','Buying Process id.','Short List','Chosen Vendor','Negotiation/Review','PO In Progress','Closed Won']
...
stage_dict = { 'Qualified':impt_stages[0:6],  'Buying Process id.':impt_stages[6:11],  'Short List':impt_stages[11:15], 
				'Chosen Vendor':impt_stages[15:18], 'Negotiation/Review':impt_stages[18:20], 'PO In Progress': impt_stages[-1]}
